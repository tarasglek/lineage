(function () {
  ...
  async function start(button) {
    ...
    try {
      const beginData = await shared.postJson('/register/begin', { inviteToken, username });
      shared.setStatus('Touch your authenticator to create a passkey...');
      const credential = await navigator.credentials.create(normalizeCreationOptions(beginData));
